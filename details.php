...
<!-- builds product details page -->
<!-- includes header and dynamically links cart -->
    <?php 
...
?>
   <!-- establishes breadcrumb navigation -->
   <div id="content">
       <div class="container">
           <div class="col-md-12">
   ...
   <?php 
    ...
    ?>       
           ...
           <!-- builds product picture carousel -->
           <div class="col-md-9">
                   ...
                   <div class="col-sm-6">
                       <div id="mainImage">
                           <div id="myCarousel" class="carousel slide" data-ride="carousel">
                               ...
                               <!-- moves product image to carasouel from DB -->
                               ...
                               <!-- builds carasoul control chevron -->
               ...
               <!-- builds recommended product list -->
               <div id="row same-heigh-row">
                   ...
                   <!-- selects recommended products at random. Selects 3 from DB -->
                   <?php 
